...
# Developed in python 34 and pygame

""" Objective of game is arrange the puzzle in order. New levels will be open
on completing each level. Click on tiles near to empty tile to move the tiles.
Click and hold right house button shows the solution.
"""
